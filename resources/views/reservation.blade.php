    ...
    <body>
        ...
        <div style="background-color: white;">
            <form action="{{ route('contact.send') }}" method="post" style=" max-width: 500px; padding:25px; margin:100px 0px 0px 500px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                @csrf
                <h2 style="color: #fb5849; margin-bottom: 20px;">Contact Us</h2>
                ...
                <button type="submit" style="background-color: #fb5849; color: white; padding: 10px 15px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px;">Submit</button>
            </form>
        </div>
